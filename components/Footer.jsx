...
const Header = () => {
  ...
  return (
    <div className=" relative col-span-4 bg-white bg-opacity-20 flex  justify-between items-center h-24 md:rounded-md">
      ...
      <div  className="hidden  text-white items-end absolute  text-lg font-bold font-mono p-5 flex-col right-0  top-[12vh] w-[400px] bg-black bg-opacity-20 rounded-sm ">
